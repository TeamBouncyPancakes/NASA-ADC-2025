...
distanceup = Text(text="Distance Travelled (km):",x=-0.97,y=0.37,size=0.02,font='assets/fonts/SpaceMono-Regular.ttf.ttf')
distancetotal = Text(text=str(distance),x=-0.97,y=0.33,size=0.04,font='assets/fonts/SpaceMono-Regular.ttf.ttf')
distancetotal._eternal = True
distanceup._eternal = True

phaseup = Text(text='Phase:',x=-0.97,y=0.47,size=0.02,font='assets/fonts/SpaceMono-Regular.ttf.ttf')
phaselabel = Text(text=phase,x=-0.97,y=0.43,size=0.04,font='assets/fonts/SpaceMono-Regular.ttf.ttf')
phaselabel._eternal = True
phaseup._eternal = True

timeup = Text(text="Time (min):",x=-0.97,y=0.27,size=0.02,font='assets/fonts/SpaceMono-Regular.ttf.ttf')
timelabel = Text(text=str(times[0]),x=-0.97,y=0.23,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.04)
...
key1 = Text(text="Color Key (Phases):",x=-0.97,y=0.15,size=0.02,font='assets/fonts/SpaceMono-Regular.ttf.ttf')

key2a = Text(text="Launch:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
key2b = Entity(model='quad',color=color.red,scale = (6,6),position=(-55,8,0))

key2a.alpha = 1
key2b.alpha = 1

key3a = Text(text="Initital Firing:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
...
key4a = Text(text="Orion Separation:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
key4b = Entity(model='quad',color=color.green,scale = (6,6),position=(-55,8,0))

key4a.alpha = 0
key4b.alpha = 0

key5a = Text(text="Subsequent Burning:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
key5b = Entity(model='quad',color=color.gold,scale = (6,6),position=(-55,8,0))

key5a.alpha = 0
key5b.alpha = 0

key6a = Text(text="Life Systems Check:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
key6b = Entity(model='quad',color=color.pink,scale = (6,6),position=(-55,8,0))

key6a.alpha = 0
key6b.alpha = 0

key7a = Text(text="Burn Fuel:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
key7b = Entity(model='quad',color=color.yellow,scale = (6,6),position=(-55,8,0))

key7a.alpha = 0
key7b.alpha = 0

key8a = Text(text="Translunar Injection:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.02)
key8b = Entity(model='quad',color=color.orange,position=(-55,8,0),scale = (6,6))

key8a.alpha = 0
key8b.alpha = 0

key9a = Text(text="Translunar Outbound:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
...
key0a = Text(text="Return:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
...
key15a = Text(text="Landing:",x=-0.97,y=0.1,font='assets/fonts/SpaceMono-Regular.ttf.ttf',size=0.03)
...
antennatitle = Text(text="Antenna priority",x=0.7,y=0,size=0.02,font='assets/fonts/SpaceMono-Regular.ttf.ttf')

antenna1 = Text(text="1) "+antennas[0]['name']+" - "+str(antennas[0]['value']),x=0.65,y=-0.05,size=0.04,font='assets/fonts/SpaceMono-Regular.ttf.ttf',color=antennas[0]['color'])

antenna2 = Text(text="2) "+antennas[1]['name']+" - "+str(antennas[1]['value']),x=0.65,y=-0.1,size=0.04,font='assets/fonts/SpaceMono-Regular.ttf.ttf',color=antennas[1]['color'])

antenna3 = Text(text="3) "+antennas[2]['name']+" - "+str(antennas[2]['value']),x=0.65,y=-0.15,size=0.04,font='assets/fonts/SpaceMono-Regular.ttf.ttf',color=antennas[2]['color'])

antenna4 = Text(text="4) "+antennas[3]['name']+" - "+str(antennas[3]['value']),x=0.65,y=-0.2,size=0.04,font='assets/fonts/SpaceMono-Regular.ttf.ttf',color=antennas[3]['color'])
